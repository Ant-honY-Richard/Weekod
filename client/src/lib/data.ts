...
export const testimonials = [
  {
    ...
    content: 'Weekod team romba nalla velai pannanga! Avanga technical skills super ah irukku. Engaloda startup website semma azhagu ah banai kondanga. Business inquiries 300% increase aachu!',
    rating: 5,
  },
  {
    name: 'Lakshmi Menon',
    ...
    content: 'Weekod team nte website design valare sundaramaayi thonni. International market il engalkku oru nalla presence undakki thannu. Export orders significantly koodi. Highly recommended!',
    rating: 5,
  },
  {
    ...
    content: 'Weekod vallu mana company ki chala bagga website chesaru. Valla technical expertise oka dam gunnundhi. Patient inquiries double ayyi, online consultations 250% perigayi!',
    rating: 5,
  },
  {
    name: 'Priya Krishnan',
    ...
    content: 'Weekod avargal engaluku oru beautiful portfolio website create pannanga. Client bookings tremendously increase aachu. Avanga design sense vera level! Romba thanks!',
    rating: 5,
  },
  {
    name: 'Ravi Shankar',
    ...
    content: 'Weekod team engaloda traditional textile business ah modern website la showcase pannanga. Online orders nalla varudhu. International customers kooda vara arambichitanga!',
    rating: 5,
  },
  {
    name: 'Divya Nair',
    ...
    content: 'Weekod nte food delivery website valare nallathaanu. Online orders koodiya mathram alla, customer reviews um nannaayi vannu. Business growth excellent aayi!',
    rating: 5,
  },
  {
    name: 'Karthik Rajan',
    ...
    content: 'Weekod team oda technical knowledge top-notch! Complex ERP system website ah perfectly develop pannanga. Performance um security um excellent level la irukku. Great work!',
    rating: 5,
  },
  {
    name: 'Meera Pillai',
    ...
    content: 'Weekod engalkku oru professional medical website undakki thannu. Patient appointments online il booking aakan easy aayi. Practice growth valare nannayi!',
    rating: 5,
  },
  {
    name: 'Srinivas Rao',
    ...
    content: 'Weekod vallu mana organic products ki chala professional website chesaru. Export inquiries roju roju vastunnai. International buyers ki mana quality chupincharu!',
    rating: 5,
  },
];
