...
const processSteps = [
  ...
  },
  {
    title: "Development",
    description:
      "We build your project using modern technologies and best practices.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
  ...
  },
  {
    title: "Testing",
    description:
      "We thoroughly test your project to ensure quality and performance.",
    icon: (
      <svg
        className="w-8 h-8"
        fill="none"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg sm:text-xl text-silver max-w-3xl mx-auto">
            We follow a proven process to deliver high-quality results on time and
            within budget.
          </p>
        </motion.div>
