            ...
            >
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="flex flex-col">
                      <a href="tel:+918088310013" className="text-accent-magenta hover:underline text-sm">(+91) 80883 10013</a>
                      <a href="tel:+919380632253" className="text-accent-magenta hover:underline text-sm">(+91) 93806 32253</a>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-6 pt-6 border-t border-dark-600">
                ...
                <div className="flex space-x-3">
                  {/* Facebook */}
                  <motion.a 
                    href="https://www.facebook.com/share/1CMTBy365s/" 
                    target="_blank"
                  ...
                  {/* Instagram */}
                  <motion.a 
                    href="https://www.instagram.com/weekod_in?igsh=MTBqd2JxY3pta3Zydw==" 
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-8 h-8 bg-dark-700 rounded-full flex items-center justify-center text-silver transition-all duration-300 relative overflow-hidden group"
                    whileHover={{ scale: 1.1, y: -2 }}
                  ...
                  {/* LinkedIn */}
                  <motion.a 
                    href="https://www.linkedin.com/company/weekod/" 
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-8 h-8 bg-dark-700 rounded-full flex items-center justify-center text-silver transition-all duration-300 relative overflow-hidden group"
                    whileHover={{ scale: 1.1, y: -2 }}
